...
export const metadata: Metadata = {
  title: 'Photography Studio Rental Coimbatore | 1200 sq ft | Lens N Stories',
  description:
    'Rent our fully-equipped 1200 sq ft photography and video studio in Coimbatore. Professional lighting, backdrops, and amenities. Hourly and daily rates available.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Professional 1200 sq ft studio facilities for photography and video production in Coimbatore',
              ...
              >
                ...
                <a
                  href={generateWhatsAppLink(
                    'studio',
                    `Hi! I'd like to book the ${tier.name} studio package.`,
                  )}
                  target='_blank'
                  rel='noopener noreferrer'
