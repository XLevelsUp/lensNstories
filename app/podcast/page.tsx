...
export const metadata: Metadata = {
  title:
    'Podcast Recording Studio Coimbatore | Professional Audio | Lens N Stories',
  description:
    'Professional podcast recording studio in Coimbatore with acoustic treatment, multi-track recording, and premium microphones. Hourly rates available. Serving Coimbatore and Tamil Nadu.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Fully-equipped podcast studio with professional acoustics in Coimbatore',
