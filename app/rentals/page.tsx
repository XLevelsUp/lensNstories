...
export const metadata: Metadata = {
  title: 'Camera & Equipment Rentals Coimbatore | Sony, Canon | Lens N Stories',
  description:
    'Rent professional cameras, lenses, lighting, and audio equipment in Coimbatore. Sony, Canon, Rode available. Daily & weekly rates. Serving Coimbatore and Tamil Nadu.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Premium photography and video equipment for rent in Coimbatore',
          ...
          <div className='mx-auto max-w-3xl'>
            ...
            <div className='space-y-4 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8'>
              ...
              <div className='flex items-start gap-3'>
                <span className='text-blue-500'>•</span>
                <p className='text-zinc-300'>
                  <strong>Security Deposit:</strong> Refundable deposit required
                  for all rentals
                </p>
              </div>
              <div className='flex items-start gap-3'>
