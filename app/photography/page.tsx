...
export const metadata: Metadata = {
  title: 'Event & Lifestyle Photography Coimbatore | Lens N Stories',
  description:
    'Professional event and lifestyle photography in Coimbatore and across India. Capturing authentic moments with creative storytelling. Wedding, portrait, and commercial photography services.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Professional photography that captures authentic moments in Coimbatore and across India',
          ...
          <div className='mx-auto grid max-w-4xl gap-6'>
            <div className='flex items-center justify-between rounded-xl border border-zinc-800 bg-zinc-900/50 p-6'>
              ...
              <a
                href={generateWhatsAppLink(
                  'photography',
                  "Hi! I'd like to inquire about event photography pricing.",
                )}
                target='_blank'
                rel='noopener noreferrer'
            ...
            <div className='flex items-center justify-between rounded-xl border border-zinc-800 bg-zinc-900/50 p-6'>
              <div>
                ...
                <p className='text-zinc-400'>
                  Personal branding, family portraits
                </p>
              </div>
              <a
                href={generateWhatsAppLink(
                  'photography',
                  "Hi! I'd like to inquire about lifestyle photography pricing.",
                )}
                target='_blank'
                rel='noopener noreferrer'
                className='rounded-full bg-amber-500 px-6 py-3 font-semibold text-zinc-950 transition-colors hover:bg-amber-400'
            ...
            <div className='flex items-center justify-between rounded-xl border border-zinc-800 bg-zinc-900/50 p-6'>
              ...
              <a
                href={generateWhatsAppLink(
                  'photography',
                  "Hi! I'd like to inquire about commercial photography pricing.",
                )}
                target='_blank'
                rel='noopener noreferrer'
                className='rounded-full bg-amber-500 px-6 py-3 font-semibold text-zinc-950 transition-colors hover:bg-amber-400'
